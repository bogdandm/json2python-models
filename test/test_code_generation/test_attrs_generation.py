...
from json_to_models.models.attr import DEFAULT_ORDER, AttrsModelCodeGenerator
...
test_data = {
    "base": {
        ...
        "fields_data": {
            "foo": {"name": "foo", "type": "int", "body": "attr.ib()"},
            "Bar": {
                "name": "bar",
                "type": "int",
                "body": f"attr.ib({field_meta('Bar')})",
            },
            "baz": {"name": "baz", "type": "float", "body": "attr.ib()"},
        },
        "fields": {
            "imports": "",
            "fields": [
